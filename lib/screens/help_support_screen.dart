...
/*
  This Canvas displays the main user interface for the "Help & Support" section, 
  integrating a live chat powered by the ChatBloc for real-time messaging, 
  providing navigation to the VideoTutorialScreen via the VideoBloc, and 
  presenting static contact information and a featured video tutorial directly 
  within its layout.
 */
...
class _HelpSupportScreenState extends State<HelpSupportScreen> {
  ...
  // Helper widget for building a single video card
